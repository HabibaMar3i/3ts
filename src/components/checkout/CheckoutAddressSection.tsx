...
export function CheckoutAddressSection({ register, errors }: CheckoutAddressSectionProps) {
        ...
        <Card className="border-slate-200 bg-white">
            ...
            <CardContent className="space-y-2">
                ...
                <div className="relative">
                    <MapPin
                        size={18}
                        className="absolute start-3 top-1/2 -translate-y-1/2 text-red-600"
                    />
                    <Input
                        id="address"
                        type="text"
                        placeholder={t('checkout.address.placeholder')}
                        className={`w-full rounded-xl border-slate-200 bg-slate-50 ps-10 pe-4 py-3 ${
